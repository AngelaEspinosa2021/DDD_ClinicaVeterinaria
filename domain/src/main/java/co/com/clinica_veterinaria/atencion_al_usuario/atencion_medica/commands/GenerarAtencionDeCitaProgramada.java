...
public class SolicitarAtencionDeCitaProgramada extends Command {
    private final CitaId citaId;
    private final Observacion observacion;
    private final FechaCita fechaCita;

    public SolicitarAtencionDeCitaProgramada(CitaId citaId, Observacion observacion, FechaCita fechaCita) {
        this.citaId = citaId;
