...
public class PrestacionDeServicioSolicitado extends DomainEvent {
    private final ServicioId servicioId;
    private final Prioridad prioridad;
    private final Fecha fechaDeSolicitud;

    public PrestacionDeServicioSolicitado(ServicioId servicioId, Prioridad prioridad, Fecha fechaDeSolicitud) {
        super("co.com.clinica_veterinaria.PrestacionDeServicioSolicitado");
